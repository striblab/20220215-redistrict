...
MAPSHAPER_CATEGORIES="Joseph R. Biden and Kamala Harris,Donald J. Trump and Michael R. Pence"
...
precincts_voting;votes;votes_pct;votes_office" | \
  cat - < \(wget -O - -o /dev/null 'https://electionresultsfiles.sos.state.mn.us/20201103/USPresPct.txt'\) > potus.csv &&

csv2json -s ";" potus.csv | ndjson-cat | \
  ndjson-split | \
