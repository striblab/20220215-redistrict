		...
		new WebpackDeployer({
		  environments: {
		    staging: {
		      region: 'us-west-1',
		      params: {
		        Bucket: 'static.startribune.com/staging/news/projects/all/20220215-redistrict/build',
		        DistributionId: '20220215-redistrict'
		      }
		    },
		    production: {
		      region: 'us-west-1',
		      params: {
		        Bucket: 'static.startribune.com/news/projects/all/20220215-redistrict/build',
		        DistributionId: '20220215-redistrict'
		      }
		    }
		  },
